...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .sendForm(
        "service_nt4ji66",        // ✅ Your actual service ID
        "template_37emu9q",       // ✅ Your actual template ID
        form.current,
        "c2_XVbXkzdRmQl3qt"       // ✅ Your actual public key
      )
      .then(
        (result) => {
    ...
    <Container id="Contact">
      <Wrapper>
        ...
        <ContactForm ref={form} onSubmit={handleSubmit}>
          ...
          <ContactInput name="email" placeholder="Your Email" required />
